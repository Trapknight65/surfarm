...
const MissionCards = () => {
    return (
        <section
            id="mission-cards"
            className="h-screen w-full flex items-center justify-center relative overflow-hidden scroll-snap-start bg-[#e0e5ec]"
        >
                        ...
                        >
                            <Link href={card.href} className="block h-full">
                                <motion.div
                                    ...
                                    className={`group relative h-full p-8 rounded-3xl neumorphic overflow-hidden transition-all duration-300 hover:neumorphic-pressed`}
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col h-full items-center text-center">
                                        <div className="mb-6 p-4 rounded-full bg-gray-100 shadow-inner group-hover:scale-110 transition-transform duration-500">
